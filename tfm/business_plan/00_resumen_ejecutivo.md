...
**Alcance.** El SkillPass no es un criptoactivo (MiCA no aplica). El evaluador no está calibrado contra evaluadores humanos: se mide acuerdo con la banda de la rúbrica, no κ de Cohen inter-evaluador. Los €180 k describen la necesidad de capital del plan. Lo construido es un plan coherente con el producto, una prueba de concepto de corrección y un sello **ya verificable**.
